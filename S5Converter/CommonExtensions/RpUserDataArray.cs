...
{
    internal enum RpUserDataFormat
    {
    ...
    internal static void Write(Dictionary<string, RpUserDataArray> d, BinaryWriter s, bool header, uint versionNum,
        uint buildNum)
    {
        if (header)
        {
            ...
            switch (reader.TokenType)
            {
                case JsonTokenType.String:
                    if (f == RpUserDataArray.RpUserDataFormat.rpSTRINGUSERDATA ||
                        f == RpUserDataArray.RpUserDataFormat.rpNAUSERDATAFORMAT)
                    {
                ...
                case JsonTokenType.Number:
                {
                    if (f == RpUserDataArray.RpUserDataFormat.rpSTRINGUSERDATA)
                        throw new JsonException("type missmatch");
                    if (f == RpUserDataArray.RpUserDataFormat.rpNAUSERDATAFORMAT ||
                ...
                case JsonTokenType.Null:
                    ...
                    {
                        f = RpUserDataArray.RpUserDataFormat.rpSTRINGUSERDATA;
                        l.Add(new RpUserDataArray.DataObj());
                        reader.Read();
                        continue;
                    }
                    else
