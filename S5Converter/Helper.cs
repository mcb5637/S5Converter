...
internal static class Helper
{
    ...
    internal static void SetFlag(this ref RwMatrix.MatrixFlagsS.MatrixFlags e, bool v,
        RwMatrix.MatrixFlagsS.MatrixFlags f)
    {
        if (v)
            e |= f;
        else
    ...
    internal static void SetFlag(this ref RpAtomic.AtomicFlagsS.AtomicFlags e, bool v,
        RpAtomic.AtomicFlagsS.AtomicFlags f)
    {
        if (v)
            e |= f;
        else
    ...
    internal static void SetFlag(this ref RpGeometry.GeometryFlagS.RpGeometryFlag e, bool v,
        RpGeometry.GeometryFlagS.RpGeometryFlag f)
    {
        if (v)
            e |= f;
        else
    ...
    internal static void SetFlag(this ref RpHAnimHierarchy.RpHAnimHierarchyFlagS.RpHAnimHierarchyFlag e, bool v,
        RpHAnimHierarchy.RpHAnimHierarchyFlagS.RpHAnimHierarchyFlag f)
    {
        if (v)
            e |= f;
        else
    ...
    internal static void SetFlag(this ref RpMeshHeader.MeshHeaderFlags.RpMeshHeaderFlags e, bool v,
        RpMeshHeader.MeshHeaderFlags.RpMeshHeaderFlags f)
    {
        if (v)
            e |= f;
        else
